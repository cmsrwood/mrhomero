    ...
    <div className=''>
      ...
      <div className='container pt-3'>
        <div className="row  g-4">
          <div className="col-12 col-sm border border-2 border-secondary text-center align-content-center py-5">
          ...
          <div className="col-12 col-sm border border-2 border-secondary text-center mx-0 mx-sm-3 align-content-cente py-5">
          ...
          <Link type="button" className=" col-12 col-sm border border-2 border-secondary text-center align-content-center py-5 text-decoration-none" data-bs-toggle="modal" data-bs-target="#staticBackdrop" >
            <div>
